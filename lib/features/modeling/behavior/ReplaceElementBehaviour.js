...
function ReplaceElementBehaviour(eventBus, bpmnReplace, bpmnRules, elementRegistry, selection, modeling) {
  ...
  this.executed( [ 'shape.replace' ], 500, function(e) {
    ...
    var oldExpanded = typeof oldShape.isExpanded !== 'undefined' ? oldShape.isExpanded : !oldShape.collapsed,
        newExpanded = typeof newShape.isExpanded !== 'undefined' ? newShape.isExpanded : !newShape.collapsed;

    if (!oldExpanded && newExpanded) {
      // all children got made visible through djs, hide empty labels
      if (newShape.children.length > 0) {
        var children = newShape.children;
